import styles from "./fsHero.module.css";
import { FaArrowAltCircleRight } from "react-icons/fa";

import GlassCarousel from "@/features/glassPanelCarousel";

export default function FSHero() {
  return (
    <section
      className={`${styles.heroSection} flex flex-row justify-center items-center`}
    >
      <div className={`${styles.heroScreen} ${styles.heroScreenBlack}`} />
      <div className={`${styles.heroScreen} ${styles.heroScreenWhite}`} />
      <div className={`${styles.heroContent}`}>
        <div
          className={`${styles.heroText} flex flex-col justify-start items-start`}
        >
          <h1>FS.Studio</h1>
          <p>
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Quis
            pariatur reiciendis natus porro temporibus! Consequuntur, aperiam
            quia nulla eos accusamus.
          </p>
          <div className="flex flex-row justify-start items-center">
            <button
              className={`${styles.buttonOne} flex flex-row justify-center items-center`}
            >
            ...
            <button
              className={`${styles.buttonTwo} flex flex-row justify-center items-center`}
            >
      ...
      <div className={styles.shapeDividerLayer2}>
        ...
        >
          ...
          <linearGradient id="MyGradient2" gradientTransform="rotate(90)">
            <stop offset="5%" stopColor="rgba(15, 15, 15, 0.2)" />
            <stop offset="95%" stopColor="rgba(15, 15, 15, 0.99)" />
          </linearGradient>
        </svg>
      </div>
