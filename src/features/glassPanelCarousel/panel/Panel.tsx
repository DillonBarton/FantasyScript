...
const Panel = ({
  ...
  return (
    <div
      className={cn(`${styles.panelWrapper} h-full`, getWrapperClass(count))}
    >
      <div
        className={cn(
          `${styles.panelContainer} h-full`,
          getContainerClass(count),
        )}
      >
        <div
          className={cn(
            `${styles.panel} flex flex-col justify-start items-center h-full`,
            getPanelClass(count),
          )}
        >
