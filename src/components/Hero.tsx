...
export default function Hero() {
  ...
  return (
    <div
      ref={heroCarousel}
      className={`${styles.heroCarouselWrapper} flexRow sc`}
    >
      <div
        ref={leftButton}
        className={`${styles.leftButton} flexRow cc`}
        onClick={() => {
          if (count <= 0) {
            setCount(initialState);
          } else {
      ...
      <div
        ref={rightButton}
        className={`${styles.rightButton} flexRow cc`}
        onClick={() => {
          if (count == numberOfContainers) {
      ...
      <div
        ref={heroContainer}
        className={`${styles.heroContainer} flexColumn cc boxW100`}
      >
        <div className={`${styles.mentorInfo} flexRow`}>
          <div className={`${styles.profileImgContainer} flexRow cc`}>
            <Image
              ...
              height={60}
              layout="intrinsic"
              src="/images/photo-1531427186611-ecfd6d936c79.jfif"
              alt="Merchant Profile Image"
            />
          </div>

          <h1 className={styles.userName}>@MentorUsername</h1>
        </div>
        ...
        <div className={`${styles.heroVideoContainer} boxW100H100`}>
          <Image
            ...
            layout="fill"
            src="/images/herobackgroundimg.jpg"
        ...
        <div className={styles.tweetContainer}>
            ...
            <div className={`${styles.tweetProfileImgContainer} flexRow cc`}>
              <div className={styles.tweetProfileImg}>
                <Image
                  ...
                  height={60}
                  layout="intrinsic"
                  src="/images/thinkingmanprofileimg.jfif"
                  alt="Merchant profile image"
                />
              </div>
            </div>
          ...
          <div className={`${styles.tweetLikesComments} flexRow ec`}>
            <div className={`${styles.Likes} flexRow cc`}>
              <div>
                <img
                  src="https://www.flaticon.com/svg/vstatic/svg/833/833472.svg?token=exp=1620833264~hmac=9fdfbf0d5ff4de1c0cdebb0af36f7fd2"
                  alt=""
                />
              </div>
              <div>24k</div>
            ...
            <div className={`${styles.Comments} flexRow cc`}>
              <div>
                <img
                  src="https://www.flaticon.com/svg/vstatic/svg/2462/2462719.svg?token=exp=1620833464~hmac=d7770a82df529c94313f95e78aadc67d"
                  alt=""
                />
              </div>
              <div>2k</div>
