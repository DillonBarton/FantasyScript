...
export default function Footer() {
  ...
  const unMountHandler = () => {
    ...
    if (sectionMounted === true) {
      ...
      slideOneTimeout = setTimeout(() => {
        slideOne.current.classList.replace(
          `${styles.sectionUnMountAnimation}`,
          `${styles.displayNone}`,
        );
      ...
      slideTwoTimeout = setTimeout(() => {
        slideTwo.current.classList.replace(
          `${styles.sectionUnMountAnimation}`,
          `${styles.displayNone}`,
        );
    ...
    mountTimout = setTimeout(() => {
      if (sectionMounted) {
        ...
        slideTwoMountTimeout = setTimeout(() => {
          slideTwo.current.classList.replace(
            `${styles.sectionOnMountAnimation}`,
            `${styles.sectionOnMountAnimation2}`,
          );
        }, 600);
      } else {
        slideOneMountTimeout = slideOne.current.classList.add(
          `${styles.sectionOnMountAnimation}`,
        );
        setTimeout(() => {
          slideOne.current.classList.replace(
  ...
  return (
    <footer id={`${styles.footerContainer}`} className={`flexColumn sc`}>
      ...
      <div
        className={`${styles.titleContainer} ${titleRerender ? styles.titleContainerAnimation : null} boxW100H100`}
      >
        <h1
          className={`${styles.floatingTitle} ${styles.titleOne} ${titleRerender ? styles.titleOneAnimation : null} ${styles[`${section}Title`]} ${sectionMounted ? styles.reverseAnimation : null}`}
        >
          {`${section}`}
        </h1>

        <div
          className={`${styles.floatingTitle} ${styles.titleTwo} ${titleRerender ? styles.titleTwoAnimation : null} ${styles[`${section}Title`]} ${sectionMounted ? styles.reverseAnimation : null}`}
        >
          {`${section}`}
        </div>

        <div
          className={`${styles.floatingTitle} ${styles.titleThree} ${titleRerender ? styles.titleThreeAnimation : null} ${styles[`${section}Title`]} ${sectionMounted ? styles.reverseAnimation : null}`}
        >
          {`${section}`}
        </div>

        <div
          className={`${styles.floatingTitle} ${styles.titleFour} ${titleRerender ? styles.titleFourAnimation : null} ${styles[`${section}Title`]} ${sectionMounted ? styles.reverseAnimation : null}`}
        >
          {`${section}`}
        </div>

        <div
          className={`${styles.floatingTitle} ${styles.titleFive} ${titleRerender ? styles.titleFiveAnimation : null} ${styles[`${section}Title`]} ${sectionMounted ? styles.reverseAnimation : null}`}
        >
          {`${section}`}
        </div>
      </div>
      ...
      <div className={`${styles.sectionContainer} boxW100 flexColumn sc`}>
        <Section
          CSMO={CSMO}
          identifier={slideOne}
          section={sections[slideOneSection]}
        />
        <Section
          CSMO={CSMO}
          identifier={slideTwo}
          section={sections[slideTwoSection]}
        />
      </div>
    </footer>
  );
...
export function InstagramSVG({ counter, section, mountHandlerFunction }) {
  return (
    <svg
      onClick={() => {
        mountHandlerFunction(2);
      }}
      className={`${styles.instagramIcon} ${section == "instagram" ? styles.iconSelected : null}`}
  ...
  switch (section) {
    case sections[0]:
      return (
        <div
          ref={identifier}
          className={`${styles.twitter} ${styles.section} boxW100`}
        >
          <a href="/" className={`${styles.imageContainer} flexRow sc`}>
            {CSMO
              ? CSMO.TwitterData && (
                  <img
                    src={CSMO.TwitterData.data.res1.includes.media[0].url}
                    alt=""
                  />
                )
              : null}
          ...
          <div className={`${styles.profileDataContainer}`}>
            <a href="" className={`${styles.profileImgContainer} flexRow ss`}>
              <img
                src={
                  CSMO
                    ? CSMO.TwitterData &&
                      CSMO.TwitterData.data.res0.data.profile_image_url
                    : null
                }
                alt=""
              />
            ...
            <div className={`${styles.profileData} flexRow se`}>
              <div>
                {CSMO
                  ? CSMO.TwitterData && CSMO.TwitterData.data.res0.data.name
                  : null}
              </div>
              <a href="/">
                @
                {CSMO
                  ? CSMO.TwitterData && CSMO.TwitterData.data.res0.data.username
                  : null}
              </a>
            </div>
            <p className={`${styles.profileDescription}`}>
              {CSMO
                ? CSMO.TwitterData &&
                  CSMO.TwitterData.data.res0.data.description
                : null}
            </p>
          </div>
          ...
          <div className={`${styles.postTextContainer}`}>
            {CSMO
              ? CSMO.TwitterData && CSMO.TwitterData.data.res1.data[0].text
              : null}
          </div>
          <div className={`${styles.postData} flexRow ec`}>
            ...
            {CSMO
              ? CSMO.TwitterData &&
                CSMO.TwitterData.data.res1.data[0].public_metrics.like_count
              : null}
            <VscComment />{" "}
            {CSMO
              ? CSMO.TwitterData &&
                CSMO.TwitterData.data.res1.data[0].public_metrics.reply_count
              : null}
            <div>
              {CSMO
                ? CSMO.TwitterData &&
                  CSMO.TwitterData.data.res1.data[0].created_at
                : null}
            </div>
          </div>
        </div>
    ...
    case sections[1]:
      return (
        <div
          ref={identifier}
          className={`${styles.facebook} ${styles.section} boxW100`}
        ></div>
      );
    ...
    case sections[2]:
      return (
        <div
          ref={identifier}
          className={`${styles.youtube} ${styles.section} boxW100`}
        ></div>
      );
    ...
    case sections[3]:
      return (
        <div
          ref={identifier}
          className={`${styles.instagram} ${styles.section} boxW100`}
        ></div>
      );
    ...
    case sections[4]:
      return (
        <div
          ref={identifier}
          className={`${styles.linkedin} ${styles.section} boxW100`}
        ></div>
      );

    default:
      return <div ref={identifier} />;
  }
}
